...
export function buildEvidenceManifestExtension(input: {
  ...
  return {
    ...
    rag: input.rag ?? {
      ...
      ragEligibleDocumentCount: 0,
      ragCandidateChunkCount: 0,
      ragEligibleChunkCount: 0,
      ragScoredChunkCount: 0,
      ragDimensionMismatchCount: 0,
      ragFilteredOutCount: 0,
      ragFilteredOutScoreRange: null,
      ragScoredScoreRange: null,
      ragSelectedScoreRange: null,
      ragTopK: null,
      ragEvidenceCount: 0,
      ragRejectedCount: 0,
      ragEvidenceIds: [],
