...
export type ActionErrorCode =
  ...
  | "SYNTHETIC_TOOL_NOT_REGISTERED"
  | "SYNTHETIC_TOOL_TYPE_MISMATCH"
  | "SYNTHETIC_CONFIRMATION_REQUIRED"
  | "SYNTHETIC_CONFIRMATION_INVALID"
  | "SYNTHETIC_SCOPE_MISMATCH"
  | "SYNTHETIC_ACTION_EXPIRED"
  | "SYNTHETIC_ACTION_TERMINAL"
  | "SYNTHETIC_EXECUTION_DUPLICATE"
  | "SYNTHETIC_REVISION_CONFLICT"
  | "SYNTHETIC_RESULT_MAPPING_FAILED"
  | "SYNTHETIC_RECONCILIATION_REQUIRED"
  | "SYNTHETIC_REDACTION_FAILURE";
