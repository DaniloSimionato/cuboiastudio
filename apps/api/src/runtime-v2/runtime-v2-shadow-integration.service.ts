...
export class RuntimeV2ShadowIntegrationService {
  ...
  private async persistCompletion(
    ...
    const metadata = {
      ...
      inheritanceEvaluated: manifest?.inheritanceEvaluated ?? false,
      inheritanceAllowed: manifest?.inheritanceAllowed ?? false,
      inheritanceBlockReason: manifest?.inheritanceBlockReason ?? null,
      ...
      ragCandidateDocumentCount: manifest?.evidence?.rag?.ragCandidateDocumentCount ?? 0,
      ragEligibleDocumentCount: manifest?.evidence?.rag?.ragEligibleDocumentCount ?? 0,
      ragCandidateChunkCount: manifest?.evidence?.rag?.ragCandidateChunkCount ?? 0,
      ragEligibleChunkCount: manifest?.evidence?.rag?.ragEligibleChunkCount ?? 0,
      ragScoredChunkCount: manifest?.evidence?.rag?.ragScoredChunkCount ?? 0,
      ragDimensionMismatchCount: manifest?.evidence?.rag?.ragDimensionMismatchCount ?? 0,
      ragFilteredOutCount: manifest?.evidence?.rag?.ragFilteredOutCount ?? 0,
      ragFilteredOutScoreRange: manifest?.evidence?.rag?.ragFilteredOutScoreRange ?? null,
      ragScoredScoreRange: manifest?.evidence?.rag?.ragScoredScoreRange ?? null,
      ragSelectedScoreRange: manifest?.evidence?.rag?.ragSelectedScoreRange ?? null,
      ragTopK: manifest?.evidence?.rag?.ragTopK ?? null,
      ...
      candidateDocumentCount: manifest?.evidence?.rag?.ragCandidateDocumentCount ?? 0,
      eligibleDocumentCount: manifest?.evidence?.rag?.ragEligibleDocumentCount ?? 0,
      candidateChunkCount: manifest?.evidence?.rag?.ragCandidateChunkCount ?? 0,
      eligibleChunkCount: manifest?.evidence?.rag?.ragEligibleChunkCount ?? 0,
      scoredChunkCount: manifest?.evidence?.rag?.ragScoredChunkCount ?? 0,
      dimensionMismatchCount: manifest?.evidence?.rag?.ragDimensionMismatchCount ?? 0,
      filteredOutCount: manifest?.evidence?.rag?.ragFilteredOutCount ?? 0,
      filteredOutScoreRange: manifest?.evidence?.rag?.ragFilteredOutScoreRange ?? null,
      scoredScoreRange: manifest?.evidence?.rag?.ragScoredScoreRange ?? null,
      selectedScoreRange: manifest?.evidence?.rag?.ragSelectedScoreRange ?? null,
      topK: manifest?.evidence?.rag?.ragTopK ?? null,
