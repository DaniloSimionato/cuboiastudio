...
import { n as useAuth } from "./_ssr/auth-DYnTR_ad.mjs";
import { t as cn } from "./_ssr/utils-C_uf36nf.mjs";
import { t as Button } from "./_ssr/button-TeH4yfmP.mjs";
import { t as companiesService } from "./_ssr/companiesService-U13G7e0M.mjs";
...
import { Ct as BookOpen, D as Rocket, Ft as LoaderCircle, Ht as Braces, K as LayoutDashboard, M as Plus, Nt as Sparkles, R as Moon, St as Bot, U as LogOut, Vt as ChartColumn, X as GitBranch, _t as ChevronDown, b as Settings, bt as Building2, ft as ChevronsRight, h as Store, k as Radio, m as Sun, n as Wrench, o as User, pt as ChevronsLeft, w as ScrollText, xt as Brain, zt as CirclePlay } from "./_libs/lucide-react.mjs";
import { a as DropdownMenuSeparator, i as DropdownMenuLabel, n as DropdownMenuContent, o as DropdownMenuTrigger, r as DropdownMenuItem, t as DropdownMenu } from "./_ssr/dropdown-menu-BRZt0Ksf.mjs";
import { P as useNavigate, f as Outlet, g as Link, l as useRouterState } from "./_libs/@tanstack/react-router+[...].mjs";
import { n as toast } from "./_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_app-BoxxAFjG.js
...
function Sidebar() {
	...
	const handleSwitchCompany = (companyId) => {
		if (companies.find((item) => item.id === companyId)?.status !== "ACTIVE") {
					...
					children: collapsed ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TooltipTrigger, {
						...
						children: [
							...
							companies.length > 0 ? companies.map((item) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DropdownMenuItem, {
								...
								children: [item.name, item.id === company?.id ? " · ativa" : item.status !== "ACTIVE" ? " · inativa" : ""]
							}, item.id, true, {
								fileName: _jsxFileName$3,
								lineNumber: 178,
								columnNumber: 21
...
function AppLayout() {
	...
	(0, import_react.useEffect)(() => {
		if (!loading && isAuthenticated && !user?.activeCompanyId) navigate({
			to: "/portal",
			replace: true
		});
	}, [
	...
	if (loading || !isAuthenticated || !user?.activeCompanyId) return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
