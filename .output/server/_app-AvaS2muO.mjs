...
import { n as useAuth } from "./_ssr/auth-DBPceM1n.mjs";
import { t as cn } from "./_ssr/utils-C_uf36nf.mjs";
import { t as Button } from "./_ssr/button-COtkgzDj.mjs";
import { t as currentCompanyService } from "./_ssr/currentCompanyService-A6Wk0NSi.mjs";
import { C as Rocket, Dt as LoaderCircle, Et as Sparkles, Mt as Braces, O as Plus, Ot as CirclePlay, P as Moon, T as Radio, V as LayoutDashboard, _ as Settings, a as User, bt as BookOpen, f as Sun, jt as ChartColumn, lt as ChevronsRight, mt as ChevronDown, n as Wrench, p as Store, q as GitBranch, ut as ChevronsLeft, vt as Brain, x as ScrollText, yt as Bot, z as LogOut } from "./_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_app-AvaS2muO.js
...
function Sidebar() {
	...
	(0, import_react.useEffect)(() => {
		let cancelled = false;
		currentCompanyService.get().then((response) => {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
					...
					children: collapsed ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TooltipTrigger, {
						...
						className: "w-64",
						children: [
							/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DropdownMenuLabel, { children: "Tenant atual" }, void 0, false, {
								fileName: _jsxFileName$3,
								lineNumber: 139,
								columnNumber: 17
							}, this),
							...
							/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DropdownMenuItem, {
								onClick: () => {
									currentCompanyService.get().then((response) => setCompany(response.company));
								},
