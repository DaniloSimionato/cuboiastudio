...
import { i as require_jsx_runtime } from "../_libs/@radix-ui/react-arrow+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DXs4gcRX.mjs");
