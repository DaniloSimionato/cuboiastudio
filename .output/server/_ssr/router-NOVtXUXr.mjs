...
import { t as Route$17 } from "../_app.agentes.novo-CpeG5ob4.mjs";
import { t as Route$18 } from "../_app.testes-BhxgDqco.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-NOVtXUXr.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_dev_runtime = require_jsx_dev_runtime();
var styles_default = "/assets/styles-BBYwATDx.css";
...
var $$splitComponentImporter$15 = () => import("./auth-LemfUGJG.mjs");
var Route$15 = createFileRoute("/auth")({
	head: () => ({ meta: [{ title: "Entrar · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$15, "component")
});
var $$splitComponentImporter$14 = () => import("../_app-AvaS2muO.mjs");
var Route$14 = createFileRoute("/_app")({ component: lazyRouteComponent($$splitComponentImporter$14, "component") });
var $$splitComponentImporter$13 = () => import("../_app.index-m-WSWSER.mjs");
var Route$13 = createFileRoute("/_app/")({
	head: () => ({ meta: [{ title: "Dashboard · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$13, "component")
});
var $$splitComponentImporter$12 = () => import("../_app.variaveis-CZ0uVqbM.mjs");
var Route$12 = createFileRoute("/_app/variaveis")({
	head: () => ({ meta: [{ title: "Variáveis · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$12, "component")
});
var $$splitComponentImporter$11 = () => import("../_app.memoria-BvmnnSxX.mjs");
var Route$11 = createFileRoute("/_app/memoria")({
	head: () => ({ meta: [{ title: "Memória · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$11, "component")
});
var $$splitComponentImporter$10 = () => import("../_app.logs-DGMHHAQ5.mjs");
var Route$10 = createFileRoute("/_app/logs")({
	head: () => ({ meta: [{ title: "Logs · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$10, "component")
});
var $$splitComponentImporter$9 = () => import("../_app.implantacao-t4eDRW1R.mjs");
var Route$9 = createFileRoute("/_app/implantacao")({
	head: () => ({ meta: [{ title: "Assistente de Implantação · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
var $$splitComponentImporter$8 = () => import("../_app.flow-CiiLlZ6s.mjs");
var Route$8 = createFileRoute("/_app/flow")({
	head: () => ({ meta: [{ title: "Flow Builder · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
var $$splitComponentImporter$7 = () => import("../_app.ferramentas-C4wnqvtm.mjs");
var Route$7 = createFileRoute("/_app/ferramentas")({
	head: () => ({ meta: [{ title: "Ferramentas · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
var $$splitComponentImporter$6 = () => import("../_app.consumo-B_oggRw8.mjs");
var Route$6 = createFileRoute("/_app/consumo")({
	head: () => ({ meta: [{ title: "Consumo IA · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
var $$splitComponentImporter$5 = () => import("../_app.conhecimento-D7HQeEL-.mjs");
var Route$5 = createFileRoute("/_app/conhecimento")({
	head: () => ({ meta: [{ title: "Base de Conhecimento · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
var $$splitComponentImporter$4 = () => import("../_app.configuracoes-CG3B9hio.mjs");
var Route$4 = createFileRoute("/_app/configuracoes")({
	head: () => ({ meta: [{ title: "Configurações · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("../_app.canais-BjBNJReI.mjs");
var Route$3 = createFileRoute("/_app/canais")({
	head: () => ({ meta: [{ title: "Canais · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
var $$splitComponentImporter$2 = () => import("../_app.apps-DBxVcMNh.mjs");
var Route$2 = createFileRoute("/_app/apps")({
	head: () => ({ meta: [{ title: "Loja de Aplicativos · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("../_app.agentes.index-Cgcn2HzI.mjs");
var Route$1 = createFileRoute("/_app/agentes/")({
	head: () => ({ meta: [{ title: "Assistentes IA · Cubo AI Studio" }] }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("../_app.apps.google-calendar-fhxcYYy9.mjs");
...
var AppVariaveisRoute = Route$12.update({
	id: "/variaveis",
	path: "/variaveis",
	getParentRoute: () => AppRoute
});
...
var AppMemoriaRoute = Route$11.update({
	id: "/memoria",
	path: "/memoria",
	getParentRoute: () => AppRoute
});
var AppLogsRoute = Route$10.update({
	id: "/logs",
	path: "/logs",
	getParentRoute: () => AppRoute
});
var AppImplantacaoRoute = Route$9.update({
	id: "/implantacao",
	path: "/implantacao",
	getParentRoute: () => AppRoute
});
var AppFlowRoute = Route$8.update({
	id: "/flow",
	path: "/flow",
	getParentRoute: () => AppRoute
});
var AppFerramentasRoute = Route$7.update({
	id: "/ferramentas",
	path: "/ferramentas",
	getParentRoute: () => AppRoute
});
var AppConsumoRoute = Route$6.update({
	id: "/consumo",
	path: "/consumo",
	getParentRoute: () => AppRoute
});
var AppConhecimentoRoute = Route$5.update({
	id: "/conhecimento",
	path: "/conhecimento",
	getParentRoute: () => AppRoute
});
var AppConfiguracoesRoute = Route$4.update({
	id: "/configuracoes",
	path: "/configuracoes",
	getParentRoute: () => AppRoute
});
var AppCanaisRoute = Route$3.update({
	id: "/canais",
	path: "/canais",
	getParentRoute: () => AppRoute
});
var AppAppsRoute = Route$2.update({
	id: "/apps",
	path: "/apps",
	getParentRoute: () => AppRoute
});
var AppAgentesIndexRoute = Route$1.update({
	id: "/agentes/",
	path: "/agentes/",
	getParentRoute: () => AppRoute
});
var AppAppsGoogleCalendarRoute = Route.update({
	id: "/google-calendar",
	path: "/google-calendar",
	getParentRoute: () => AppAppsRoute
});
var AppAgentesNovoRoute = Route$17.update({
	id: "/agentes/novo",
	path: "/agentes/novo",
	getParentRoute: () => AppRoute
});
var AppAppsRouteChildren = { AppAppsGoogleCalendarRoute };
var AppRouteChildren = {
	AppAppsRoute: AppAppsRoute._addFileChildren(AppAppsRouteChildren),
	AppCanaisRoute,
