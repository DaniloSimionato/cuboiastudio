//#region node_modules/.nitro/vite/services/ssr/assets/apiClient-DG1jAm9p.js
...
async function apiFetch(path, init = {}) {
	...
	try {
		...
		throw new ApiError(0, err instanceof DOMException && err.name === "AbortError" ? "A solicitação demorou demais. Tente novamente." : buildNetworkErrorMessage(requestUrl));
	} finally {
