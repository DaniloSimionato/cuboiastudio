...
export const AssistantBehaviorTab = forwardRef<AssistantBehaviorTabRef, AssistantBehaviorTabProps>(({ assistantId }, ref) => {
  const [loading, setLoading] = useState(true);
  const [saving, setSaving] = useState(false);
  const [behavior, setBehavior] = useState<Partial<AssistantBehavior>>({
    attendantName: "",
